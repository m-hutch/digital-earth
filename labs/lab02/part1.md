---
layout: default
title: Creating a QGIS project 
description: Learn how to create a new QGIS project and open existing projects
permalink: /labs/lab02/part1
active: True
nav: False
multi: True
next: part2
prev: part1
---
<span class='alert'>Before continuing, make sure you have installed QGIS, downloaded the lab 2 data folder, and saved & extracted the data folder to your `lab2` folder on your computer</span>
...
6. In the Browser panel, click the arrow next to your `Project` folder to expand the contents. Make sure you can seee the unzipped `data` folder. Also expand the `data` folder. Make sure you can see three data files.
    ...
    <span class='alert'>If you can't see these files, you did not save the project in the correct place. Go to `Project > Save As` in the menu bar and make sure to save the project in the correct location.</span>
